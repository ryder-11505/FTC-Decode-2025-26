...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = - 2845.7; // y position of the parallel encoder (in tick units) 2.75 in
        public double perpXTicks =  5691.39; // x position of the perpendicular encoder (in tick units) 5.5 in
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        driver.setOffsets(-57.15, -146.05, DistanceUnit.MM);
